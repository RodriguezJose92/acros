...
class MudiExperience {
    ...
    createStyles() {
        ...
        link.href = `https://cdn.jsdelivr.net/gh/RodriguezJose92/acros@latest/index.css`; /* custom this path */
    ...
    createModal() {
                ...
                <div class="containerBtnsActions">
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/acros@latest/assets/step3.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/acros@latest/assets/step4.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/acros@latest/assets/step2.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/acros@latest/assets/step1.webp">
                                </div>
        ...
        modalMudi.querySelector(`#imgARBtn`).addEventListener('click', () => {
            ...
            if (window.innerWidth > 1000) {
                !flagAR
                    ? (
                        document.body.querySelector('.containerQRMudi').style.right = "4%",
                        document.body.querySelector('.containerQRMudi').style.height = "650%",
...
setTimeout(() => {
    ...
    if (skuElement) {
        ...
        const container = document.querySelector('.vtex-stack-layout-0-x-stackContainer ');
